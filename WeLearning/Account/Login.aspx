<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WeLearning.Account.Login" Async="true" %>
    ...
    <main aria-labelledby="title">
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="row">
                    <h4>Use your WeLearning account to log in!</h4>
                    <hr />
